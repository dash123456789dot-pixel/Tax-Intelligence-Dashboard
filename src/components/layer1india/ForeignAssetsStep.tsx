...
// ────────────────────────────────────────────────────────────────────────
// ForeignAssetsStep.tsx
// React port of panel-step-fa ("Screen 2J — Foreign Assets / Schedule FA
// & FSI") from layer1_india.html.
// ────────────────────────────────────────────────────────────────────────

import React, { useState, useEffect } from 'react';
import { useMachine } from '@xstate/react';
import { foreignAssetsMachine } from '@/machines/foreignAssetsMachine';
import { formatINRDisplay } from '@/machines/deriveForeignAssets';
...
function YesNoTriState({ value, onYes, onNo, yesLabel = 'Yes', noLabel = 'No' }: any) {
  return (
          ...
          <div id="div-fa-table-container" className="flex flex-col gap-4">
            ...
            <div className="p-5 bg-white/5 border border-white/5 rounded-2xl flex flex-col gap-4 mt-2">
              ...
              <div id="div-fa-list" className="space-y-4">
                {fa.assets.map((row: any, idx: number) => (
