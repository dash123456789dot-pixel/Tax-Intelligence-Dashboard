...
import { businessMachine } from '@/machines/businessMachine';
import { formatINRDisplay, BusinessEntry } from '@/machines/deriveBusiness';
...
function InrField({ id, value, onCommit, className = '', placeholder }: InrFieldProps) {
...
function Accordion({ icon, title, defaultOpen = false, dimmed = false, children }: AccordionProps) {
  return (
    <details
