...
function UploadBox({ status, onStart }: any) {
  ...
  return (
    <div className={`mt-2 border-2 border-dashed ${borderClass} rounded-xl p-4 text-center cursor-pointer transition-colors relative`} onClick={(e) => (e.currentTarget.querySelector('input') as HTMLInputElement)?.click()}>
    ...
    <div id="panel-step-bank" className="glass-card p-6 lg:p-8 flex flex-col gap-6">
      ...
      <div className="p-5 bg-white/5 border border-white/5 rounded-2xl flex flex-col gap-4">
        ...
        <div id="div-bank-list" className="grid grid-cols-1 gap-4">
          {bank_accounts.map((row: any, idx: number) => (
